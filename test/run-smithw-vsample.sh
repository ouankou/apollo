...
for n_size in {32..4000..256} {4096..20000..384}; do
 let "counter += 1"
...
# I think so: measures are added into the feature + policy    
  APOLLO_TRACE_FOLDER_SUFFIX=$FOLDER_SUFFIX APOLLO_CROSS_EXECUTION_MIN_DATAPOINT_COUNT=50 \
